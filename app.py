...
# import secrets
# >>>  from the python terminal secrets.SystemRandom().getrandbits(128)

    api = Api(app)
    app.config["JWT_SECRET_KEY"] = "145183851310817528582975645563356785403"
    jwt = JWTManager(app)
    ...
    def add_claims_to_jwt(identity):
        # instead of using 1 you would verify the user is admin through the database
        if identity == 1:
